...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MUL = 7,                        /* MUL  */
  YYSYMBOL_DIV = 8,                        /* DIV  */
  YYSYMBOL_LEFT_PRA = 9,                   /* LEFT_PRA  */
  YYSYMBOL_RIGHT_PRA = 10,                 /* RIGHT_PRA  */
...
static const char *const yytname[] =
{
  ...
  "SUB", "MUL", "DIV", "LEFT_PRA", "RIGHT_PRA", "UMINUS", "';'", "$accept",
...
#line 66 "third.y"
         { yyval = (char *)malloc(50*sizeof (char));
           strcpy(yyval, yyvsp[0]); 
           strcat(yyval," "); }
#line 1165 "third.tab.c"
    break;


#line 1169 "third.tab.c"
